                ...
                {is_fan
                    ? <div onClick={
                        () => {
                            ...
                            fetch('like_api/v1/posts/' + post.id + '/unlike/', {
                                method: 'POST',
                                headers: {'X-CSRFToken': Cookies.get('csrftoken')},
                            }).then((response) => response.ok ? setIs_fan(false) : setIs_fan(true))
                        }
                    }><svg viewBox="0 0 391.837 391.837" xmlSpace="preserve"><g><path d="M285.257,35.528c58.743,0.286,106.294,47.836,106.58,106.58   c0,107.624-195.918,214.204-195.918,214.204S0,248.165,0,142.108c0-58.862,47.717-106.58,106.58-106.58l0,0   c36.032-0.281,69.718,17.842,89.339,48.065C215.674,53.517,249.273,35.441,285.257,35.528z"/></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg></div>
                    : <div onClick={
                        () => {
                            post.total_likes += 1

                            fetch('like_api/v1/posts/' + post.id + '/like/', {
                                method: 'POST',
                                headers: {'X-CSRFToken': Cookies.get('csrftoken')},
